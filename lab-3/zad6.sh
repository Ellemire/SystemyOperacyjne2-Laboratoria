...
# To działa ale chyba jest źle bo nie sprawdzam czy TYLKO właścicel ma prawa do zmiany
find linux-5.11.13 -type f -size -1024c -perm -u+w | wc -l
# find linux-5.11.13 -type f -size -1024c -perm -u+w ! -perm /g+w,o+w | wc -l
# find linux-5.11.13 -type f -size -1024c -perm -200 ! -perm /022 | wc -l